...
<%@page contentType="text/html" pageEncoding="UTF-8" import="user.Account" import="static java.lang.System.out" %>
<!DOCTYPE html>
<html lang="en">
            ...
            <header class="header">
                ...
                <div class="container-md main">
                    ...
                    <div class="main-left">
                        ...
                        <ul class="list-group">
                            <a href=""><li class="list-group-item">Thông tin mượn sách</li></a>
                            <a href="searchControl"><li class="list-group-item">Tìm kiếm sách</li></a>

                            <a href=""><li class="list-group-item">Góp ý thêm sách</li></a>    
                        </ul>
                    </div>
